...
void gui() {
  ...
  lv_obj_set_flex_align(allianceRow, LV_FLEX_ALIGN_SPACE_BETWEEN,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);

  lv_obj_set_flex_flow(sideRow, LV_FLEX_FLOW_ROW);
  lv_obj_set_flex_align(sideRow, LV_FLEX_ALIGN_SPACE_BETWEEN,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);

  lv_obj_set_flex_flow(skillsRow, LV_FLEX_FLOW_ROW);
  lv_obj_set_flex_align(skillsRow, LV_FLEX_ALIGN_SPACE_BETWEEN,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);

  lv_obj_set_flex_flow(elimRow, LV_FLEX_FLOW_ROW);
  lv_obj_set_flex_align(elimRow, LV_FLEX_ALIGN_SPACE_BETWEEN,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
  ...
  lv_obj_set_style_bg_color(allianceSwitch, lv_color_hex(0xed2626),
                            LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(sideSwitch, lv_color_hex(0xa8d600),
                            LV_STATE_CHECKED | LV_PART_INDICATOR);
  lv_obj_set_style_bg_color(sideSwitch, lv_color_hex(0x2484e3),
                            LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(skillsSwitch, lv_color_hex(0x31cc43),
                            LV_STATE_CHECKED | LV_PART_INDICATOR);
  lv_obj_set_style_bg_color(elimSwitch, lv_color_hex(0x31cc43),
                            LV_STATE_DEFAULT);
  lv_obj_set_style_bg_color(elimSwitch, lv_color_hex(0xed2626),
                            LV_STATE_CHECKED | LV_PART_INDICATOR);

  lv_obj_add_event_cb(allianceSwitch, allianceSwitchCb, LV_EVENT_VALUE_CHANGED,
                      NULL);
  lv_obj_add_event_cb(sideSwitch, sideSwitchCb, LV_EVENT_VALUE_CHANGED, NULL);
  lv_obj_add_event_cb(skillsSwitch, skillsSwitchCb, LV_EVENT_VALUE_CHANGED,
                      NULL);
  ...
  lv_obj_set_flex_align(odomContainer, LV_FLEX_ALIGN_SPACE_BETWEEN,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
